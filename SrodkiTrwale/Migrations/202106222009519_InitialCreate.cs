    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.Amortization", t => t.AmortizationId, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Amortization", t => t.Amortization_ID)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.FixedAssets", "Amortization_ID", "dbo.Amortization");
            DropForeignKey("dbo.AmortizationRow", "FixedAssetId", "dbo.FixedAssets");
            ...
            DropForeignKey("dbo.AmortizationRow", "AmortizationId", "dbo.Amortization");
            ...
            DropIndex("dbo.AmortizationRow", new[] { "FixedAssetId" });
            DropIndex("dbo.AmortizationRow", new[] { "AmortizationId" });
            DropTable("dbo.Raports");
            DropTable("dbo.UserRoles");
            DropTable("dbo.Users");
            DropTable("dbo.Categories");
            DropTable("dbo.FixedAssets");
            DropTable("dbo.AmortizationRow");
            DropTable("dbo.Amortization");
        }
    }
}
